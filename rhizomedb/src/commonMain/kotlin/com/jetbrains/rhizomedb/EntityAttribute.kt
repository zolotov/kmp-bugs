 ...
 * */
fun <E : Entity, T : Any> entities(entityAttribute: EntityAttribute<E, T>, value: T): Set<E> =
...
@Deprecated(
    ...
    ReplaceWith(
        ...
        "fleet.util.singleOrNullOrThrow"
    )
)
...
inline fun <E : Entity, T : Any, reified C : E> entitiesCasted(
    entityAttribute: EntityAttribute<E, T>,
    value: T
): Set<C> =
