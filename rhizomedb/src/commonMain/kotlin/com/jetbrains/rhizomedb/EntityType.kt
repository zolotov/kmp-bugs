...
abstract class EntityType<E : Entity>(
    ...
    constructor(
        ...
        reify: (EID) -> E,
        vararg mixins: Mixin<in E>
    ) : this(requireNotNull(ident.qualifiedName), entityModule(ident), reify, *mixins)
    ...
    companion object : EntityType<EntityType<*>>("rhizomedb.EntityType", "rhizome", {
        error(
            "Entity type can't be constructed given just EID. " +
 ...
 * */
internal fun <E : Entity> EntityType<E>.buildAttributes(builder: EntityBuilder<E>): List<Pair<Attribute<*>, Any>> =
    let { entityType ->
        buildList {
